...
public class XPagedTable extends Table {
    ...
    public class PagedTableChangeEvent {
        ...
        final XPagedTable table;

        public PagedTableChangeEvent(XPagedTable table) {
            this.table = table;
        }

        public XPagedTable getTable() {
            return table;
        }
    ...
    public XPagedTable(String caption) {
        super(caption);
        setPageLength(10);
    ...
    public HorizontalLayout createControls() {
        ...
        // =================================================================
        Label itemsPerPageLabel = new Label("Items per page:", ContentMode.HTML);
        // =================================================================
        ...
        currentPageTextField.addValueChangeListener(new ValueChangeListener() {
            ...
            public void valueChange(com.vaadin.data.Property.ValueChangeEvent event) {
                if (currentPageTextField.getValue() != null) {
                	String currentPage = String.valueOf(currentPageTextField.getValue()).replace(",", "");
                    int page = Integer.valueOf(currentPage);
                    
                    if (page < 1 || page > getTotalAmountOfPages()) {
                    	Notification.show("Wrong page number", Notification.Type.WARNING_MESSAGE);
                    } else {
                        setCurrentPage(page);	
                    }
                }
        ...
        currentPageTextField.setWidth("60");
...
//        pageManagement.setSizeUndefined();
        ...
        controlBar.setExpandRatio(pageSize, 1);	// 設定元件在空間中的比例
        controlBar.setExpandRatio(pageManagement, 3);
//        controlBar.setWidth("500");
    ...
    public void setContainerDataSource(Container newDataSource) {
        if (!(newDataSource instanceof Container.Indexed)) {
            throw new IllegalArgumentException(
                    "XPagedTable can only use containers that implement Container.Indexed");
        }
